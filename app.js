...
function calculate() {
    ...
    document.getElementById('age').innerText = `${years} лет, ${months} месяцев, ${days} дней, ${hours} часов, ${minutes} минут, ${seconds} секунд`;
    document.getElementById('nextBirthday').innerText = `${nextBirthday.toLocaleDateString()}`;
    document.getElementById('daysToNextBirthday').innerText = `${daysToNextBirthday} дня(ей)`;
    document.getElementById('chineseZodiac').innerText = `${chineseZodiacSign}`;
}
